...
public:
	...
	void ZapDel(int start, int count);
	...
	int GetAttr(int pos) { return attrs[pos]; };
	wxUniChar GetChar(int pos) { return chars[pos]; };
	void SetCharAttr(int pos, char chr, int atr);
...
private:
	...
	wxPoint m_ptBeginSelect;
	wxPoint m_ptEndSelect;
	bool    m_isSelecting;
