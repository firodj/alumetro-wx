 ...
 * 1) Download it from: 
 *    http://www.litwindow.com/Knowhow/Intellisense/_wx_intellisense.h
 * 2) Add it to your Visual Studio project, but it does not have to be 
 *    #included in any source file.
 * 3) Close the project and delete the *.ncb file of the project.
 * 4) Reopen the project.
 *    VS .NET 2002 is especially prone to crashes while it parses the file. 
 *    If it does, close it and try again.
 * 5) Add "wx/something.h" and "wx/msw/something.h" includes to 
 *    _wx_intellisense.h everytime you are using a new wxWidgets class 
